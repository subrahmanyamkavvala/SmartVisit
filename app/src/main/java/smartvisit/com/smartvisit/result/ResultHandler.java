...
package smartvisit.com.smartvisit.result;
...
import smartvisit.com.smartvisit.Contents;
import smartvisit.com.smartvisit.Intents;
import smartvisit.com.smartvisit.LocaleManager;
import smartvisit.com.smartvisit.PreferencesActivity;
import smartvisit.com.smartvisit.R;
import smartvisit.com.smartvisit.book.SearchBookContentsActivity;
...
public abstract class ResultHandler {
  ...
  final void openBookSearch(String isbn) {
    Uri uri = Uri.parse("http://books.google." + LocaleManager
            .getBookSearchCountryTLD(activity) +
        "/books?vid=isbn" + isbn);
    launchIntent(new Intent(Intent.ACTION_VIEW, uri));
  }
